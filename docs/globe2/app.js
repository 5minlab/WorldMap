...
let features=[]; let boundaryMesh=null; let landGeom=null; let capitals=[];
const nameByCcn3=new Map(); const capByCcn3=new Map();
let selected=null; let isDragging=false; let lastPos=[0,0]; let lastRotate=[0,0,0];
...
// hover selects + HUD (no capital in HUD)
